...
Si el primer mensaje o una conversacion sin contexto es "que valor tiene", "cuanto vale" o "cuanto cuesta" sin decir entrada, stand ni participar, no asumas. Responde ambas posibilidades: entrada para visitantes 100% gratuita y stands de expositor entre $3.300.000 y $6.000.000 COP. Cierra preguntando si viene como visitante o si piensa participar con su marca.
